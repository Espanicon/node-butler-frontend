      ...
      <div className={styles.container}>
        <Section>
          <SectionWithLogo path="/images/icon-logo.png" float="left">
            ...
            <p>
              Are you part of a validator team in the <b>ICON</b> Network
              looking to collaborate? or are you a newcomer looking for someone
              with experience working in the <b>ICON</b> ecosystem to built an
              exciting and new project?.
            </p>
